...
% manual_first_start: (optional) %sets first start time to beginning of data log (used if first start_display command is missed)
...
da_start = 10.05; %seconds after start of trial to start data analysis
