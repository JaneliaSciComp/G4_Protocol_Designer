...
function G4_Plot_Data_flyingdetector(exp_folder, trial_options, metadata_for_publishing, CL_conds, OL_conds, TC_conds)
...
%%%%%SECTION ADDED BY LISA TAYLOR 7/1/19
...
%% Timeseries data plots for open-loop trials
if ~isempty(OL_conds)
